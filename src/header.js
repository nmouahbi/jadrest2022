export const loadHeader = () => {
  ...
  logo.src = "components/images/menu/main.jpeg";
  ...
  rightElementsContainer.append(themeToggleSwitch);

  // cartButton, ctaButton
...
const changeIconsColor = (isThemeDark) => {
  ...
  if (isThemeDark) {
    headerLogo.src = 'components/images/menu/main.jpeg';
